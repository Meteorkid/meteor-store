      ...
      <div className="fixed inset-0 z-50 overflow-y-auto overscroll-contain">
        ...
        >
          ...
          <div className="mb-6 grid grid-cols-2 gap-3">
            ...
            <button
              type="button"
              onClick={() => showToast(t('wechatInDevelopment'))}
              aria-disabled="true"
              className={`relative py-3 px-4 rounded-lg border text-center transition-colors ${
                'bg-white/5 border-white/10 text-gray-500 hover:bg-white/10'
              }`}
            >
              <span className="inline-flex items-center justify-center gap-2">
                <svg viewBox="0 0 24 24" className="h-5 w-5 flex-shrink-0 opacity-70" fill="#07C160" aria-hidden="true">
                ...
                <span className="rounded-full bg-amber-500/15 px-2 py-0.5 text-[0.6875rem] font-medium text-amber-400">
                  {t('wechatComingSoon')}
                </span>
              </span>
            </button>
