  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="glass-card relative rounded-3xl p-10 md:p-14 text-center scroll-animate">
          {/* Background grid */}
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
                <input
                  ...
                  className="glass flex-1 px-4 py-3 rounded-lg text-foreground placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm transition-all"
                />
