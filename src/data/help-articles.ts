...
export const helpArticles: HelpArticleMeta[] = [
  ...
  },
  {
    ...
    commercial: false,
    relatedSlugs: [],
    title: { zh: '如何使用 Pathfinder 发现机会并制定学习路径', en: 'How to Discover Opportunities and Build a Pathfinder Plan' },
    excerpt: {
      zh: '浏览可信的开源、竞赛、实习与 AI 动态，并围绕真实目标生成 4–8 周学习路径。',
      en: 'Browse trusted open-source, competition, internship, and AI updates, then build a four-to-eight-week path around a real goal.',
    },
    keywords: {
      zh: ['Pathfinder', '学习路径', '开源项目', '竞赛', '实习', 'AI 动态'],
      en: ['Pathfinder', 'learning path', 'open source', 'competition', 'internship', 'AI updates'],
    },
  },
